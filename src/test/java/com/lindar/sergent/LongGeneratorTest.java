...
class LongGeneratorTest {
    ...
    void testWithMaxInvalidArguments(){
        assertThrows(IllegalArgumentException.class, () -> sergent.longGenerator().withMax(Long.MAX_VALUE), "Max >= Long.MAX_VALUE shouldn't be allowed");
        assertThrows(IllegalArgumentException.class, () -> sergent.longGenerator().withMax(Long.MIN_VALUE), "Max less then 0 shouldn't be allowed");
        assertThrows(IllegalArgumentException.class, () -> sergent.longGenerator().withMax(0), "Max less then or equal to 0 shouldn't be allowed");
        assertThrows(IllegalArgumentException.class, () -> sergent.longGenerator().withMax(-1), "Max less then or equal to 0 shouldn't be allowed");
    }
    ...
    void testWithMinAndMaxInvalidArguments(){
        assertThrows(IllegalArgumentException.class, () -> sergent.longGenerator().withMinAndMax(0, Long.MAX_VALUE), "Max >= Long.MAX_VALUE shouldn't be allowed");
        assertThrows(IllegalArgumentException.class, () -> sergent.longGenerator().withMinAndMax(0, Long.MIN_VALUE), "Max <= 0 shouldn't be allowed");
        assertThrows(IllegalArgumentException.class, () -> sergent.longGenerator().withMinAndMax(0, 0), "Max <= 0 shouldn't be allowed");
        assertThrows(IllegalArgumentException.class, () -> sergent.longGenerator().withMinAndMax(0, -1), "Max <= 0 shouldn't be allowed");
        assertThrows(IllegalArgumentException.class, () -> sergent.longGenerator().withMinAndMax(10, 5), "Max < Min shouldn't be allowed");
        assertThrows(IllegalArgumentException.class, () -> sergent.longGenerator().withMinAndMax(-5, -10), "Max < Min shouldn't be allowed");
    }

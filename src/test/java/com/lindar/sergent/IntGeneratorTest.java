...
class IntGeneratorTest {
    ...
    void testWithMaxInvalidArguments(){
        assertThrows(IllegalArgumentException.class, () -> sergent.intGenerator().withMax(Integer.MAX_VALUE), "Max >= Integer.MAX_VALUE shouldn't be allowed");
        assertThrows(IllegalArgumentException.class, () -> sergent.intGenerator().withMax(Integer.MIN_VALUE), "Max less then 0 shouldn't be allowed");
        assertThrows(IllegalArgumentException.class, () -> sergent.intGenerator().withMax(0), "Max less then or equal to 0 shouldn't be allowed");
        assertThrows(IllegalArgumentException.class, () -> sergent.intGenerator().withMax(-1), "Max less then or equal to 0 shouldn't be allowed");
    }

    @Test
    @DisplayName("Test using withMinAndMax (Positive Ranges)")
    void testWithMinAndMaxPositiveRanges(){
    ...
    void testWithMinAndMaxNegativeToPositiveRanges(){
    ...
    void testWithMinAndMaxNegativeRanges(){
    ...
    void testWithMinAndMaxInvalidArguments(){
        assertThrows(IllegalArgumentException.class, () -> sergent.intGenerator().withMinAndMax(0, Integer.MAX_VALUE), "Max >= Integer.MAX_VALUE shouldn't be allowed");
        assertThrows(IllegalArgumentException.class, () -> sergent.intGenerator().withMinAndMax(0, Integer.MIN_VALUE), "Max <= 0 shouldn't be allowed");
        assertThrows(IllegalArgumentException.class, () -> sergent.intGenerator().withMinAndMax(0, 0), "Max <= 0 shouldn't be allowed");
        assertThrows(IllegalArgumentException.class, () -> sergent.intGenerator().withMinAndMax(0, -1), "Max <= 0 shouldn't be allowed");
        assertThrows(IllegalArgumentException.class, () -> sergent.intGenerator().withMinAndMax(10, 5), "Max < Min shouldn't be allowed");
        assertThrows(IllegalArgumentException.class, () -> sergent.intGenerator().withMinAndMax(-5, -10), "Max < Min shouldn't be allowed");
    }

    @Test
    @DisplayName("Test using ignore with positive numbers")
    void testIgnorePositive(){
        // single number
    ...
    void testIgnoreNegativePositive(){
        // single number
    ...
    private void testAllNumbersInRange(List<Integer> list, int min, int max){
        Assertions.assertFalse(list.stream().anyMatch(r -> r < min || r > max), "All numbers should be between "+min+" and "+max+" inclusive");
    }

    private void testAllNumbersInRange(List<Integer> list, int min, int max, List<Integer> ignore){
        Assertions.assertFalse(list.stream().anyMatch(r -> r < min || r > max || ignore.contains(r)), "All numbers should be between "+min+" and "+max+" inclusive and not " + ignore + ", list="+list);
    }

    private void testAllNumbersIgnore(List<Integer> list, List<Integer> ignore){
        Assertions.assertFalse(list.stream().anyMatch(ignore::contains), "All numbers should be not be " + ignore);
    }
